...
@Injectable()
export class OrganisationInvoicePopupService {
        ...
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                this.organisationService.find(id).subscribe((organisation) => {
                    organisation.createdOn = this.datePipe
                        .transform(organisation.createdOn, 'yyyy-MM-ddTHH:mm:ss');
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.organisationModalRef(component, new OrganisationInvoice());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    organisationModalRef(component: Component, organisation: OrganisationInvoice): NgbModalRef {
