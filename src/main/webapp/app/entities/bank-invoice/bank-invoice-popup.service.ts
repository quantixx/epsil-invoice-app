...
@Injectable()
export class BankInvoicePopupService {
    ...
    open(component: Component, id?: number | any): Promise<NgbModalRef> {
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.bankModalRef(component, new BankInvoice());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    bankModalRef(component: Component, bank: BankInvoice): NgbModalRef {
