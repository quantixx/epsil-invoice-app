...
@Injectable()
export class CurrencyInvoicePopupService {
    ...
    open(component: Component, id?: number | any): Promise<NgbModalRef> {
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.currencyModalRef(component, new CurrencyInvoice());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    currencyModalRef(component: Component, currency: CurrencyInvoice): NgbModalRef {
