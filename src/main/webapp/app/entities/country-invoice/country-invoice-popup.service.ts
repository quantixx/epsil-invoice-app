...
@Injectable()
export class CountryInvoicePopupService {
    ...
    open(component: Component, id?: number | any): Promise<NgbModalRef> {
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.countryModalRef(component, new CountryInvoice());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    countryModalRef(component: Component, country: CountryInvoice): NgbModalRef {
