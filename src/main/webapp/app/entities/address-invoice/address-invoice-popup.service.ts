...
@Injectable()
export class AddressInvoicePopupService {
    ...
    open(component: Component, id?: number | any): Promise<NgbModalRef> {
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.addressModalRef(component, new AddressInvoice());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    addressModalRef(component: Component, address: AddressInvoice): NgbModalRef {
