...
@Component({
    selector: 'inv-invoice-invoice',
    templateUrl: './invoice-invoice.component.html'
})
export class InvoiceInvoiceComponent implements OnInit, OnDestroy {
...
currentAccount: any;
    ...
    transition() {
        this.router.navigate(['/invoice-invoice'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: InvoiceInvoice) {
        return item.id;
    }
