...
import io.epsil.invoice.config.audit.AuditEventConverter;
import io.epsil.invoice.domain.PersistentAuditEvent;
...
import static io.epsil.invoice.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
