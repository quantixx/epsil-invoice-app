...
describe('Service Tests', () => {
    ...
    describe('OrganisationInvoice Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(OrganisationInvoiceService);
        ...
        describe('Service methods', () => {
            ...
            it('should return OrganisationInvoice', () => {

                let entity: OrganisationInvoice;
                service.find(123).subscribe((_entity: OrganisationInvoice) => {
                    entity = _entity;
                });
