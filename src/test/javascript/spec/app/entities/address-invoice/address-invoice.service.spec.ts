...
describe('Service Tests', () => {
    ...
    describe('AddressInvoice Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(AddressInvoiceService);
        ...
        describe('Service methods', () => {
            ...
            it('should return AddressInvoice', () => {

                let entity: AddressInvoice;
                service.find(123).subscribe((_entity: AddressInvoice) => {
                    entity = _entity;
                });
