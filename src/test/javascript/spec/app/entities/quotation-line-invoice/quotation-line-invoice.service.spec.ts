...
describe('Service Tests', () => {
    ...
    describe('QuotationLineInvoice Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(QuotationLineInvoiceService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/quotation-lines';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return QuotationLineInvoice', () => {

                let entity: QuotationLineInvoice;
                service.find(123).subscribe((_entity: QuotationLineInvoice) => {
                    entity = _entity;
                });
