...
describe('Service Tests', () => {
    ...
    describe('DocumentInvoice Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(DocumentInvoiceService);
        ...
        describe('Service methods', () => {
            ...
            it('should return DocumentInvoice', () => {

                let entity: DocumentInvoice;
                service.find(123).subscribe((_entity: DocumentInvoice) => {
                    entity = _entity;
                });
