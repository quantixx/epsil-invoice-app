...
describe('Service Tests', () => {
    ...
    describe('QuotationDefinitionInvoice Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(QuotationDefinitionInvoiceService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/quotation-definitions';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return QuotationDefinitionInvoice', () => {

                let entity: QuotationDefinitionInvoice;
                service.find(123).subscribe((_entity: QuotationDefinitionInvoice) => {
                    entity = _entity;
                });
