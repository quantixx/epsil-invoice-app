...
describe('Service Tests', () => {
    ...
    describe('InvoiceStateInvoice Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(InvoiceStateInvoiceService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/invoice-states';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return InvoiceStateInvoice', () => {

                let entity: InvoiceStateInvoice;
                service.find(123).subscribe((_entity: InvoiceStateInvoice) => {
                    entity = _entity;
                });
