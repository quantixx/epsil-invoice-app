...
describe('Service Tests', () => {
    ...
    describe('InvoiceInvoice Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(InvoiceInvoiceService);
        ...
        describe('Service methods', () => {
            ...
            it('should return InvoiceInvoice', () => {

                let entity: InvoiceInvoice;
                service.find(123).subscribe((_entity: InvoiceInvoice) => {
                    entity = _entity;
                });
