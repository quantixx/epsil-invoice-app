...
describe('Service Tests', () => {
    ...
    describe('CurrencyInvoice Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(CurrencyInvoiceService);
        ...
        describe('Service methods', () => {
            ...
            it('should return CurrencyInvoice', () => {

                let entity: CurrencyInvoice;
                service.find(123).subscribe((_entity: CurrencyInvoice) => {
                    entity = _entity;
                });
