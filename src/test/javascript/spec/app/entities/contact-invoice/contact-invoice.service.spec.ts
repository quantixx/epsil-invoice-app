...
describe('Service Tests', () => {
    ...
    describe('ContactInvoice Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(ContactInvoiceService);
        ...
        describe('Service methods', () => {
            ...
            it('should return ContactInvoice', () => {

                let entity: ContactInvoice;
                service.find(123).subscribe((_entity: ContactInvoice) => {
                    entity = _entity;
                });
