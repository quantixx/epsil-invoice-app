...
describe('Service Tests', () => {
    ...
    describe('InvoiceLineInvoice Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(InvoiceLineInvoiceService);
        ...
        describe('Service methods', () => {
            ...
            it('should return InvoiceLineInvoice', () => {

                let entity: InvoiceLineInvoice;
                service.find(123).subscribe((_entity: InvoiceLineInvoice) => {
                    entity = _entity;
                });
