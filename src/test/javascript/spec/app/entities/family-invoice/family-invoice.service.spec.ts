...
describe('Service Tests', () => {
    ...
    describe('FamilyInvoice Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(FamilyInvoiceService);
        ...
        describe('Service methods', () => {
            ...
            it('should return FamilyInvoice', () => {

                let entity: FamilyInvoice;
                service.find(123).subscribe((_entity: FamilyInvoice) => {
                    entity = _entity;
                });
