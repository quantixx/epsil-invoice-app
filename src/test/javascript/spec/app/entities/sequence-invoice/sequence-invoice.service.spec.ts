...
describe('Service Tests', () => {
    ...
    describe('SequenceInvoice Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(SequenceInvoiceService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/sequences';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return SequenceInvoice', () => {

                let entity: SequenceInvoice;
                service.find(123).subscribe((_entity: SequenceInvoice) => {
                    entity = _entity;
                });
