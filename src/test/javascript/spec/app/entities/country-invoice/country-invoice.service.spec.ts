...
describe('Service Tests', () => {
    ...
    describe('CountryInvoice Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(CountryInvoiceService);
        ...
        describe('Service methods', () => {
            ...
            it('should return CountryInvoice', () => {

                let entity: CountryInvoice;
                service.find(123).subscribe((_entity: CountryInvoice) => {
                    entity = _entity;
                });
