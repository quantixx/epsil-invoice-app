...
describe('Service Tests', () => {
    ...
    describe('InvoiceDefinitionInvoice Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(InvoiceDefinitionInvoiceService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/invoice-definitions';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return InvoiceDefinitionInvoice', () => {

                let entity: InvoiceDefinitionInvoice;
                service.find(123).subscribe((_entity: InvoiceDefinitionInvoice) => {
                    entity = _entity;
                });
