...
describe('Service Tests', () => {
    ...
    describe('LanguageInvoice Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(LanguageInvoiceService);
        ...
        describe('Service methods', () => {
            ...
            it('should return LanguageInvoice', () => {

                let entity: LanguageInvoice;
                service.find(123).subscribe((_entity: LanguageInvoice) => {
                    entity = _entity;
                });
