...
import { InvLoginModalComponent } from '../../../../../../main/webapp/app/shared/login/login.component';
...
describe('Component Tests', () => {
    ...
    describe('LoginComponent', () => {
        ...
        let comp: InvLoginModalComponent;
        let fixture: ComponentFixture<InvLoginModalComponent>;
        ...
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [InvLoginModalComponent],
                providers : [
                    {
            ...
            .overrideTemplate(InvLoginModalComponent, '')
            .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(InvLoginModalComponent);
